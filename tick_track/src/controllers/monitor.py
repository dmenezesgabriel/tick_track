...
from src.models.operational_system import (
    OperationalSystem as OperationalSystem,
)
from src.models.time_entry import TimeEntry as TimeEntry
from src.models.activity import Activity
from src.models.activity import ActivityIndex as ActivityIndex
    ...
    try:
        while _should_run:
            ...
            if user_idle_controller.user_idle_seconds > 600:
                ...
                active_window_name = platform_helper.os_get_active_window(
                    os_name
                )
            ...
            if active_window_name != previous_active_window_name:
                ...
                activity = Activity.get_or_create(
                    name=active_window_name, operational_system=os_object
                )

                if activity[1]:
                    # Create activity index
                    ActivityIndex.create(
                        rowid=activity[0].id, name=activity[0].name
                    )
